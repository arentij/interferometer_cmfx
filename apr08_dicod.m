tic
file_name = 'apr10/CMFX_847_scope.csv';
...
signal_co2 = data1(1:downsampling:end,3);
driver_co2 = data1(1:downsampling:end,4);

signal_red = data1(1:downsampling:end,1);
driver_red = data1(1:downsampling:end,2);
